...
_CENTERNET_DEEPMACMASKESTIMATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pointly_supervised_keypoint_loss_weight', full_name='object_detection.protos.CenterNet.DeepMACMaskEstimation.pointly_supervised_keypoint_loss_weight', index=32,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ignore_per_class_box_overlap', full_name='object_detection.protos.CenterNet.DeepMACMaskEstimation.ignore_per_class_box_overlap', index=33,
